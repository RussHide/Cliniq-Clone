    ...
    return (
        <div className="container mx-auto flex justify-center items-center gap-x-10">
            <div className="w-1/2">
                ...
                <p className='text-gray-400'>A community in which all people achieve their full potential for health and well-being across the lifespan. We work to be trusted by patients, a valued partner in the community, and creators of positive.</p>
